...
@implementation FacebookStyleBar {
    UIView *blueBarView;
    BLKFlexibleHeightBarSubviewLayoutAttributes *initialBlueBarLayoutAttributes;
    BLKFlexibleHeightBarSubviewLayoutAttributes *finalBlueBarLayoutAttributes;
    UITextField *searchField;
    BLKFlexibleHeightBarSubviewLayoutAttributes *initialSearchFieldLayoutAttributes;
    BLKFlexibleHeightBarSubviewLayoutAttributes *finalSearchFieldLayoutAttributes;
    UIView *whiteBarView;
    BLKFlexibleHeightBarSubviewLayoutAttributes *initialWhiteBarLayoutAttributes;
    BLKFlexibleHeightBarSubviewLayoutAttributes *finalWhiteBarLayoutAttributes;
    UIView *bottomBorderView;
    UIView *leftVerticalDividerView;
    UIView *rightVerticalDividerView;
}
...
- (void)configureBar
{
    ...
    if(blueBarView == nil) {
        // Add blue bar view
        blueBarView = [[UIView alloc] init];
        blueBarView.backgroundColor = self.backgroundColor;
        
        initialBlueBarLayoutAttributes = [[BLKFlexibleHeightBarSubviewLayoutAttributes alloc] init];
        ...
        finalBlueBarLayoutAttributes = [[BLKFlexibleHeightBarSubviewLayoutAttributes alloc] initWithExistingLayoutAttributes:initialBlueBarLayoutAttributes];
    ...
    if(searchField == nil) {
        ...
        initialSearchFieldLayoutAttributes = [[BLKFlexibleHeightBarSubviewLayoutAttributes alloc] init];
        ...
        finalSearchFieldLayoutAttributes = [[BLKFlexibleHeightBarSubviewLayoutAttributes alloc] initWithExistingLayoutAttributes:initialSearchFieldLayoutAttributes];
    ...
    if(whiteBarView == nil) {
        // Add white bar view
        whiteBarView = [[UIView alloc] init];
        whiteBarView.backgroundColor = [UIColor whiteColor];
        
        initialWhiteBarLayoutAttributes = [[BLKFlexibleHeightBarSubviewLayoutAttributes alloc] init];
        ...
        finalWhiteBarLayoutAttributes = [[BLKFlexibleHeightBarSubviewLayoutAttributes alloc] initWithExistingLayoutAttributes:initialWhiteBarLayoutAttributes];
    ...
    if(bottomBorderView == nil ) {
        ...
        bottomBorderView = [[UIView alloc] initWithFrame:CGRectMake(0.0, initialWhiteBarLayoutAttributes.size.height-0.5, initialWhiteBarLayoutAttributes.size.width, 0.5)];
        ...
        leftVerticalDividerView = [[UIView alloc] initWithFrame:CGRectMake(initialWhiteBarLayoutAttributes.size.width*0.334, initialWhiteBarLayoutAttributes.size.height*0.1, 0.5, initialWhiteBarLayoutAttributes.size.height*0.8)];
        ...
        rightVerticalDividerView = [[UIView alloc] initWithFrame:CGRectMake(initialWhiteBarLayoutAttributes.size.width*0.667, initialWhiteBarLayoutAttributes.size.height*0.1, 0.5, initialWhiteBarLayoutAttributes.size.height*0.8)];
    ...
    bottomBorderView.frame = CGRectMake(0.0, initialWhiteBarLayoutAttributes.size.height-0.5, initialWhiteBarLayoutAttributes.size.width, 0.5);
    leftVerticalDividerView.frame = CGRectMake(initialWhiteBarLayoutAttributes.size.width*0.334, initialWhiteBarLayoutAttributes.size.height*0.1, 0.5, initialWhiteBarLayoutAttributes.size.height*0.8);
    rightVerticalDividerView.frame = CGRectMake(initialWhiteBarLayoutAttributes.size.width*0.667, initialWhiteBarLayoutAttributes.size.height*0.1, 0.5, initialWhiteBarLayoutAttributes.size.height*0.8);
}

-(void)layoutSubviews {
    [super layoutSubviews];
    //NSLog(@"LAYING OUT: %f", self.frame.size.width);
    [self configureBar];
}
